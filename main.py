...
if __name__ == "__main__":
    try:
        ...
        # HAY UN ERROR POR QUE NO CREA EL BAT DE MQTT Y EL LA VENTANA DE TELEGRAF NO GUARDA LA CARPETA DE TRABAJO, TAMBIEN TOCARIA VER COMO PARSEAR EL TOKEN PARA QUE QUEDE AUTOMATICO Y TAMBIEN QUE GUARDE UN ARCHIVO JSON EN EL COMPUTADOR PARA TENER TODO CENTRALIZADO CON LAS CONFIGURACIONES